      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        <ScrollReveal delay={0.1}>
          <p className="mx-auto mt-4 max-w-xl text-center text-base leading-relaxed text-text-secondary md:text-lg">
            For collaborations, technical conversations, or ideas worth building — find me through the links below.
          </p>
        </ScrollReveal>
          ...
          <ScrollReveal delay={0.2}>
            <div className="flex h-full flex-col justify-between gap-6 rounded-2xl border border-white/[0.06] bg-galaxy-dark/40 p-6 backdrop-blur-md">
              <div>
                ...
                <p className="mt-2 font-medium text-white">{personalInfo.location}</p>
                <p className="mt-1 text-xs leading-5 text-text-secondary/60">
                  The archive is open. Pick a world and explore.
                </p>
              </div>
